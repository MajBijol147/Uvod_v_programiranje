...
def prenesi(racun1, racun2, koliko):
    if (racun1.stanje - koliko) < 0:
        ...
        racun1.stanje = racun1.stanje - koliko
        racun2.stanje = racun2.stanje + koliko
        return True
...
def _validate_current_file():
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjoxNzEyLCJ1c2VyIjoxMDczMH0:1u4fHW:c8ouNbzqHi9N7TpYxg8ei6wu7-ycAeBUy3ggdj02af0"
        try:
            test_data = [
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjoxNzEzLCJ1c2VyIjoxMDczMH0:1u4fHW:mNmcLj1OJICdexQdjBlFPvSXNVAN0iCkBeSdVpmrOLM"
        try:
            test_data = [
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjoxNzE0LCJ1c2VyIjoxMDczMH0:1u4fHW:xzu35ANT1uXazgFkxLIAEFy-fiAVTHUheJBXN1UsE_Y"
        try:
            test_data = [
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjoxNzE1LCJ1c2VyIjoxMDczMH0:1u4fHW:0mw4RxYV4M6JbTDGr1XCCg6vBGjjsvEhvNI5CE5tr-Y"
        try:
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjoxNzE2LCJ1c2VyIjoxMDczMH0:1u4fHW:up9yUl1HfE5dBPquXvXms_zL2qrUP78WI37bZDcRFL8"
        try:
            test_data = [
