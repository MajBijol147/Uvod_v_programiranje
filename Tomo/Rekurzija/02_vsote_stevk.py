...
def vsota_stevk(n):
    ...
    if n < 1:
        ...
        return n_stevka + vsota_stevk(n // 10)
...
def vsota_vecjih_stevk(n, k=0):
    ...
    if n < 1:
        ...
        return n_stevka + vsota_vecjih_stevk(n // 10, k)
...
def _validate_current_file():
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0Ijo5NTYsInVzZXIiOjEwNzMwfQ:1tpSLy:kegjcwQbEff0_kgKOr_KXe9aQ7ePzuvrLx7-_MUXPvs"
        try:
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0Ijo5NTcsInVzZXIiOjEwNzMwfQ:1tpSLy:wl5_00diFvoHHNEgkbhAdemaKrY6r6VAjjypZXH3vdQ"
        try:
            try:
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0Ijo5NTgsInVzZXIiOjEwNzMwfQ:1tpSLy:XrF1tmQ1tmYhio-Oyk3SnZ1K9BTe1q_S9mubB8khEyA"
        try:
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0Ijo5NTksInVzZXIiOjEwNzMwfQ:1tpSLy:iWN9M89kG9GuNx99Ioj7oMJqdiNSP0dwI9WVjjkt8zo"
        try:
            for i in range(1, 100):
