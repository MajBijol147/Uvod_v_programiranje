...
#      SICER BO RED NAREDILA POLICIJA!'
# =============================================================================
def prepisi_in_zagrozi(dat1, dat2):
    with open(dat1, encoding='UTF-8') as vhod:
        vrstica = vhod.read()
        nova_vrstica = vrstica.upper().replace(".", "!")
    with open(dat2, "w", encoding='UTF-8') as izhod:
        izhod.write(nova_vrstica)
    return dat2
...
def _validate_current_file():
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjoyMDM0NiwidXNlciI6MTA3MzB9:1u7Cjf:vMFbtEfuADOM4i6cA-LL-UvCLaZ3BmK78TYSQXtms-0"
        try:
            test_cases = [
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjoyMDM0NywidXNlciI6MTA3MzB9:1u7Cjf:3ukaNxyvmZsbPfYqN7ovyQTwyEolbXTSExvWrVAueAs"
        try:
            test_cases = [
