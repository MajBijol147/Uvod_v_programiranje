...
def prestej_posebno(niz, c, k):
    if k == 0:
        ...
        if indeks == -1:
            ...
            return prestej_posebno(niz[indeks + 1:], c, k - 1)
...
def _validate_current_file():
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjoyNzQ5MSwidXNlciI6MTA3MzB9:1trzW4:YU23TDmXCOlH4jtkkevsalPem_NAudRT1bn4s15TGV4"
        try:
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjoyNzQ5MiwidXNlciI6MTA3MzB9:1trzW4:lqTzOPn9jDim3d3YrJUfuXcTfV5NrU11mn1RhY9TIpw"
        try:
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjoyNzQ4MywidXNlciI6MTA3MzB9:1trzW4:P8YwE6GDI7Kda9GagsJe_UVU9pKRkA7m9gJKeGjRj-w"
        try:
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjoyNzQ4NCwidXNlciI6MTA3MzB9:1trzW4:txaO-0EWOZV_2Yhn6mbp9QpLx5Kf6YgCU65Grzk_iHU"
        try:
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjoyNzQ4NSwidXNlciI6MTA3MzB9:1trzW4:k_6dOGo9zGnentpS8ACO9ZqZO0dxmJnAGNQnJ6JVuCc"
        try:
