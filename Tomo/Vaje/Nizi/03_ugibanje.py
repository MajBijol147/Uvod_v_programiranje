...
def preberi_celo_stevilo():
    ...
    if stevilo.isdigit() == True:
        return int(stevilo)
    elif stevilo[0] == "-" and stevilo[1:].isdigit() == True:
        return int(stevilo)
    else:
...
def _validate_current_file():
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjoyNzQ5NiwidXNlciI6MTA3MzB9:1ts0R0:84t3QAS1dgA9cbhR4ncuARwUxzIA9M-nhkVhk9BJN18"
        try:
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjoyNzQ5NywidXNlciI6MTA3MzB9:1ts0R0:CJeIUQBQ0RoujzHmdhVJ9McnFHqNRhHoB2N777rYNCQ"
        try:
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjoyNzYyMywidXNlciI6MTA3MzB9:1ts0R0:5lXomQM4RKrkhkamQTEhvxV0E947REkyaRZiCgeZl3s"
        try:
