...
# =============================================================================
    def __str__(self):
        ...
        for vrstica in self.matrika:
                for i, clen in enumerate(vrstica):
                    if vrstica == self.matrika[len(self.matrika) - 1]:
                        if len(vrstica) == 1:
                            izpis += f"{clen}"
                        else:
                            if i == len(vrstica) - 1:
...
# =============================================================================
    def __add__(self, other):
        return Matrika([[self.matrika[i][j] + other.matrika[i][j] for j in range(self.sirina)] for i in range(self.visina)])
# =====================================================================@027766=
# 5. podnaloga
...
def _validate_current_file():
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjoyNzc2MiwidXNlciI6MTA3MzB9:1uJytI:VV0J3FXeGglhb4x5uOxRm2zMnC4urrqE-GnOE2j4nco"
        try:
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjoyNzc2MywidXNlciI6MTA3MzB9:1uJytI:OuQHKkgES1xqBIlziCT3dVi1QMUrHZRwJLGMquYzVJI"
        try:
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjoyNzc2NCwidXNlciI6MTA3MzB9:1uJytI:HDOuRRmoT-ghYujzjvJ4oj6gFvGAntJczNe7KHgN7DI"
        try:
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjoyNzc2NSwidXNlciI6MTA3MzB9:1uJytI:yCiX-nahURCH8dCYGyqbSWQ0S1AY7axzm4w5mqNKmhA"
        try:
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjoyNzc2NiwidXNlciI6MTA3MzB9:1uJytI:fpFKPUkI37AFFtYQN3XoAmP6KoHcxyDVI760n99BQqc"
        try:
