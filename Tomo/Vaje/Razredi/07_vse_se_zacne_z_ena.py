...
def rightmost_one_bit(n):
    """
    Vrni položaj prve enice (z desne) v binarnem zapisu števila n.
    
    Primeri:
      * rightmost_one_bit(36) = 2, saj je 36 = 100100 v dvojiškem sestavu;
      * rightmost_one_bit(18) = 1, saj je 18 = 10010;
      * rightmost_one_bit(9) = 0, saj je 9 = 1001.
    """
    cnt = 0
    while n % 2 == 0:
        cnt += 1
...
def _validate_current_file():
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjoxOTI4LCJ1c2VyIjoxMDczMH0:1uK0EZ:lnShsnhfpTw55n60IQyZ7GmMSWqwoIjST_YBL8vhg9M"
        try:
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjoxOTI5LCJ1c2VyIjoxMDczMH0:1uK0EZ:LYFLWtr6fjjFrImS6bGGnvTETZRew0IXRrnVekOt9kA"
        try:
