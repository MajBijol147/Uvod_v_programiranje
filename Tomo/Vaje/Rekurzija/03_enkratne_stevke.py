...
def ali_ima_enkratne_stevke(n):
    if n < 10:
        return True
    elif kolikokrat_se_pojavi_stevka(n % 10, n) > 1:
        return False
    else:
...
def _validate_current_file():
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjoyMDAyNSwidXNlciI6MTA3MzB9:1tpSrK:VV9FGuj9kYLKm9KXBmc8QdtEzSMH6TBs4GNp_16Mjf0"
        try:
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjoyMDAyNiwidXNlciI6MTA3MzB9:1tpSrK:gk_zQ1tm4Yo9eff4kXeKAribuILRP1tXogJlYqRxzDw"
        try:
