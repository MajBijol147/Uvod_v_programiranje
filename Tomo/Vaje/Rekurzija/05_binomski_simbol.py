...
def binomski_ucinkovit(n, k):
    return int(((n - k + 1) / k) * binomski_fakulteta(n, k - 1))
...
def _validate_current_file():
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0Ijo5NTAsInVzZXIiOjEwNzMwfQ:1tppG6:l67pWANhU_L4tv-OP2zvwHVvZI64OKGXbB5D0OzCEwE"
        try:
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0Ijo5NTEsInVzZXIiOjEwNzMwfQ:1tppG6:cglQTNOZn51T06wZ-NqGloOtU1R42b0j9aQiyBvTppQ"
        try:
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0Ijo5NTIsInVzZXIiOjEwNzMwfQ:1tppG6:MufIyqro1pSzEg8YOn5vgRou04VjmZg9oYmIUcyU4p8"
        try:
