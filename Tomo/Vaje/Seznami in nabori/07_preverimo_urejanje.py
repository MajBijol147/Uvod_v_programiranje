...
# =============================================================================
def pripravi_primer(sezel, sezin):
    primer = []
    for i in range(len(sezel)):
        primer.append((sezel[i], sezin[i]))
    return primer
# =====================================================================@027625=
# 2. podnaloga
...
def _validate_current_file():
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjoyNzYyNCwidXNlciI6MTA3MzB9:1u76My:dJEobgLMkZHRktRbrFjecr0t1cs0b9-xlI6ppLOgZT4"
        try:
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjoyNzYyNSwidXNlciI6MTA3MzB9:1u76My:O-00aa5YZb633BiIcmCLoeBl0Voa9aTKCAc3fX3_eQw"
        try:
