...
def cikli(permutacija):
    seznam_ciklov = list()
    mnozica_elementov = set()
    for kljuc in range(1, len(permutacija) + 1):
        if kljuc not in mnozica_elementov:
            c = cikel(permutacija, kljuc)
...
def _validate_current_file():
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjoxMzc5LCJ1c2VyIjoxMDczMH0:1tzbSH:_FqS9dvEOF1VP9eysDoluwKsn63Ewux3A_DFAkbJ5kU"
        try:
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjoxMzgwLCJ1c2VyIjoxMDczMH0:1tzbSH:hCvmRAUKJGQ244ftKL67uwr2NfeiiR10rV6knstL4FU"
        try:
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjoxMzgxLCJ1c2VyIjoxMDczMH0:1tzbSH:BZdiGY1KEvpNpzX44dTbdNBZMC-h2fzAx8cpdpt77os"
        try:
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjoxMzgyLCJ1c2VyIjoxMDczMH0:1tzbSH:zfh_h8mkzb9cBQLam9lDgUqBDLgdYPqahjvZ7LzDmfU"
        try:
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjoxMzgzLCJ1c2VyIjoxMDczMH0:1tzbSH:wPuTGZ0FiuQNEaNmYoxbifrz2vsQD77Pk1z1OTgCH58"
        try:
