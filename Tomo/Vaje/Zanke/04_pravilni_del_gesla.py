...
# =============================================================================
def pravilni_del_gesla(geslo, ugibane_črke):
    uganjeno =""
    for črka in geslo:
        if črka in ugibane_črke:
            uganjeno = uganjeno + črka
        else:
            uganjeno = uganjeno + "_"
    return uganjeno
# =====================================================================@024176=
...
#     'j?'
# =============================================================================
def nepravilni_ugibi(geslo, ugibane_črke):
    napačne = ""
    for črka in ugibane_črke:
        if črka not in geslo:
            napačne = napačne + črka
    return napačne
...
def _validate_current_file():
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjoyNDE3NSwidXNlciI6MTA3MzB9:1tuXmM:B6EgHzRBoZokFgCZ6ymTL3OEPo8huLYAU4_Czsnyb-s"
        try:
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjoyNDE3NiwidXNlciI6MTA3MzB9:1tuXmM:Jg_x1dO6dw8pCtkYJyPp8emor_UNXGxU-eVkr00hSVM"
        try:
