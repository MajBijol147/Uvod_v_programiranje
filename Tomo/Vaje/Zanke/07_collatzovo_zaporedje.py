...
def najdaljse_zaporedje(m, n):
    ...
    for i in range(m, n + 1):
        if dolzina_zaporedja(i) > M:
            M = dolzina_zaporedja(i)
    return M
...
def _validate_current_file():
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0Ijo5ODUsInVzZXIiOjEwNzMwfQ:1tuYn2:iqLenAuI1pRtChKkpPVUVc4hYnk_krrJRi5SxsXc7GM"
        try:
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0Ijo5ODYsInVzZXIiOjEwNzMwfQ:1tuYn2:peL_kt6XnNXECeG1ntHdQH2NNu1jmTABSAqo6IHI0GU"
        try:
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0Ijo5ODcsInVzZXIiOjEwNzMwfQ:1tuYn2:kpSfMM5vSHn8e514a5n5LNbKTWad9mrDjrrm54JFb4A"
        try:
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0Ijo5ODgsInVzZXIiOjEwNzMwfQ:1tuYn2:cq7KmDTkFFXCKaqsSe6c-QU2g_GaiiH5fjg3gqbBUlc"
        try:
