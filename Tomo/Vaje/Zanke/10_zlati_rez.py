...
# podano natančnost.
# =============================================================================
def natancni_priblizek(natančnost):
    if natančnost < 0:
        return None
    else:
        k = 1
        while abs(priblizek(k) - priblizek(k - 1)) > natančnost:
            k = k + 1
        return priblizek(k)
...
def _validate_current_file():
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjoxMDAwLCJ1c2VyIjoxMDczMH0:1tubQl:o9aRidyCdP-bWNRy_8MMgjUekA3yHoL2pwnZz0fyEow"
        try:
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjoxMDAxLCJ1c2VyIjoxMDczMH0:1tubQl:DKVbmY-2fPIIP-czdfVtRF3DMHeNORxbV04mME9o_VY"
        try:
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjoxMDAyLCJ1c2VyIjoxMDczMH0:1tubQl:esCYHrtWAfJ91chpDKgR2dvwnGak-5Z3icDdMhOBtXU"
        try:
