...
# =============================================================================
def priblizek_po_korakih(n, k=1):
    priblizek = n / 2
    for i in range(k):
...
def _validate_current_file():
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjoxMDAzLCJ1c2VyIjoxMDczMH0:1tuXuJ:pt-OVA9Lu1zWePKikoCyrYiLhZiTyz8nh77kQuA4nBA"
        try:
    ...
    if Check.part():
        Check.current_part[
            "token"
        ] = "eyJwYXJ0IjoxMDA0LCJ1c2VyIjoxMDczMH0:1tuXuJ:EqRPL-kugKV3G-iBqjTeiKGZxBHNcVidD5aMHahkxfc"
        try:
